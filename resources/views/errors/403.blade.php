...
<head>
  ...
  <title>Access Forbidden | Toxaway Knitting Co.</title>
...
<body class="bg-stone-50 text-stone-900">
  <div class="min-h-screen flex flex-col items-center justify-center px-4">
    <div class="text-center max-w-md">
      ...
      <!-- Error Title -->
      <h2 class="text-3xl font-bold text-stone-900 mb-2">Access Forbidden</h2>
      ...
      <p class="text-stone-500 text-sm mt-8">
        Need help? <a href="{{ route('contact') }}" class="text-blue-600 hover:underline">Contact us</a>
      </p>
    </div>
  </div>
</body>
